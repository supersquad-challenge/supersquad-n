...
import { useNeoWallets } from '../../../context/NeoLine';
    ...
    <main>
      {isMount && (
        <>
          ...
          <BodyContainer>
            <BodyTitle>Connect Wallet</BodyTitle>
            <WalletContainer onClick={() => connectMetaMask()}>
              <Image
            ...
            <WalletContainer onClick={() => connectNeoLine()}>
              <Image
                src="/assets/neoline.svg"
                alt="connect neoline"
                width={100}
                height={50}
                style={{
            ...
            <WalletContainer onClick={() => connectWeb3Wallet()}>
              <Image
          ...
          {isError && <CommonError msg="Metamask connect failed" />}
          {(showSucces || isConnected) && (
            <SuccessContainer>
              <Check />
              <SuccessMsg>Successfully Connected</SuccessMsg>
